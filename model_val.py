...
class RecurrentAttention(nn.Module):
    ...
    def __init__(
        self, g, k, s, c, h_g, h_l, std, hidden_size, act_dimension,
    ):
        """Constructor.
        ...
        self.classifier = modules.ActionNetwork(hidden_size, act_dimension)
        self.baseliner = modules.BaselineNetwork(hidden_size, 1)

    def forward(self, x, l_t_prev, h_t_prev, epoch, t, is_test, last=False):
