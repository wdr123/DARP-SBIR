...
glimpse_arg.add_argument(
    "--patch_size", type=int, default=5, help="size of extracted patch at highest res"
)
glimpse_arg.add_argument(
...
glimpse_arg.add_argument(
    "--loc_hidden", type=int, default=256, help="hidden size of loc fc"
)
glimpse_arg.add_argument(
    "--glimpse_hidden", type=int, default=256, help="hidden size of glimpse fc"
)
...
core_arg.add_argument(
    "--num_glimpses", type=int, default=12, help="# of glimpses, i.e. BPTT iterations"
)
core_arg.add_argument("--hidden_size", type=int, default=512, help="hidden size of rnn")


# reinforce params
reinforce_arg = add_argument_group("Reinforce Params")
reinforce_arg.add_argument(
    "--std", type=float, default=0.2, help="gaussian policy standard deviation"
)
reinforce_arg.add_argument(
...
train_arg.add_argument(
    "--epochs", type=int, default=600, help="# of epochs to train for"
)
train_arg.add_argument(
    "--init_lr", type=float, default=1e-3, help="Initial learning rate value"
)
train_arg.add_argument(
    "--lr_patience",
    type=int,
...
misc_arg.add_argument(
    "--plot_freq", type=int, default=4, help="How frequently to plot glimpses"
)
