...
class RecurrentAttention(nn.Module):
    ...
    def __init__(
        ...
        self.classifier = modules.ActionNetwork(input_size, num_classes)
    ...
    def forward(self, x, is_test, last=False):
        ...
        if last:
            action = self.classifier(x, is_test)
            # return h_t, l_t, b_t, action, a_p, log_pi, entropy
            return action

        # return h_t, l_t, b_t, log_pi, entropy
        # return action, a_p
