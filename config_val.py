...
glimpse_arg.add_argument(
    "--loc_hidden", type=int, default=64, help="hidden size of loc fc"
)
glimpse_arg.add_argument(
    "--glimpse_hidden", type=int, default=64, help="hidden size of glimpse fc"
)
...
core_arg.add_argument("--hidden_size", type=int, default=128, help="hidden size of rnn")
...
train_arg.add_argument(
    "--epochs", type=int, default=400, help="# of epochs to train for"
)
train_arg.add_argument(
